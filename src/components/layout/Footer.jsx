      ...
      <div className="max-w-7xl mx-auto px-4 py-12 grid md:grid-cols-3 gap-8 text-sm">
        <div>
          <div className="flex items-center gap-3">
            ...
            />
            <span className="font-semibold">Senna Condomínios e Imóveis</span>
          </div>
          ...
          <div className="mt-4 flex gap-3">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="pill px-4 py-2 bg-green-600 text-white"
            >
              WhatsApp
            </a>
            <a
              href="mailto:comercial@sennacondominioseimoveis.com.br"
              className="pill px-4 py-2 border border-gray-300"
            >
              E-mail
            </a>
          </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-black/80">
            <li>
              <a href="/#servicos" className="hover:text-black">
                Serviços
              </a>
            </li>
            <li>
          ...
          <div className="space-y-4">
            <div>
              ...
              <a
                ...
                className="text-black hover:text-[var(--brand-accent)] transition font-medium"
              >
                (21) 99762-7530
              </a>
            </div>
            <div>
              ...
              <a
                href="mailto:comercial@sennacondominioseimoveis.com.br"
                className="text-black hover:text-[var(--brand-accent)] transition font-medium break-all"
              >
