...
export default function Condominio() {
  const structuredData = {
    ...
    "description":
      "Administração completa de condomínios no Rio de Janeiro: gestão financeira, assembleias, manutenção predial, assessoria jurídica e portal do condômino.",
    "serviceType": "Administração de condomínios",
    "areaServed": "Rio de Janeiro, RJ",
    "url": "https://administradoracapital.com.br/condominio",
    "provider": {
  ...
  return (
    <>
      <SEO
        title="Administração de Condomínios no Rio de Janeiro | Capital Administradora"
        description="Gestão condominial completa no RJ: prestação de contas transparente, cobrança, assembleias, manutenção predial e portal do condômino. Peça um orçamento."
        keywords="Capital Administradora, administração de condomínios Rio de Janeiro, administradora de condomínios RJ, gestão condominial, prestação de contas condomínio, assembleia de condomínio, portal do condômino, manutenção predial RJ"
        canonicalUrl="https://administradoracapital.com.br/condominio"
    ...
    <main>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white text-center p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div className="w-16 h-16 bg-brand-graphite/10 rounded-full flex items-center justify-center mx-auto mb-6">
                <Wrench className="w-8 h-8 text-brand-graphite" />
              </div>
            ...
            <div className="bg-white text-center p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div className="w-16 h-16 bg-brand-graphite/10 rounded-full flex items-center justify-center mx-auto mb-6">
                <Users className="w-8 h-8 text-brand-graphite" />
              </div>
            ...
            <div className="bg-white text-center p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div className="w-16 h-16 bg-brand-graphite/10 rounded-full flex items-center justify-center mx-auto mb-6">
                <Scale className="w-8 h-8 text-brand-graphite" />
              </div>
      ...
      {/* Benefits Section */}
      <section className="section-padding bg-gradient-to-br from-[var(--brand-muted)] to-[var(--brand-off-white)] overflow-hidden">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <SectionTitle
              badge="Vantagens"
              title="Por que escolher a Capital?"
            />
          </div>
      ...
      <section className="section-padding bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h3 className="text-3xl md:text-4xl font-bold mb-6">
            ...
            <span className="text-metal-ink">profissional</span>?
          </h3>
