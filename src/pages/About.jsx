        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-16">
            <SectionTitle
              ...
              title="Senna Condomínios e Imóveis"
            />
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
            <div className="space-y-6">
              <p className="text-lg leading-relaxed text-gray-700">
                A <strong>Senna Condomínios e Imóveis</strong> é uma empresa com experiência no mercado imobiliário, realizando administração de condomínios, locações, compra e venda de imóveis.
              </p>
              <p className="text-lg leading-relaxed text-gray-700">
                Nosso diferencial é o <span className="text-yellow-600 font-semibold">atendimento personalizado</span> direcionado à necessidade de cada cliente.
              </p>
              <p className="text-lg leading-relaxed text-gray-700">
            ...
            <div className="relative">
              ...
              />
              <div className="absolute -bottom-6 -left-6 w-32 h-32 bg-gradient-to-br from-yellow-500 to-yellow-600 rounded-3xl opacity-20"></div>
            </div>
          </div>
          ...
          <div className="mt-20 text-center">
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-3xl p-12">
              <h3 className="text-2xl md:text-3xl font-bold mb-6">
                ...
                <span className="text-yellow-600">parceria</span>
              </h3>
